...
import 'package:last_mile/reviewPage.dart';
...
class Carts extends StatefulWidget {
  ...
  const Carts({Key key, this.product}) : super(key: key);
  @override
  Cart createState() => Cart(this.product);
                              ...
                              Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: <Widget>[
                                      ...
                                      InkWell(
                                          onTap: ()=>Navigator.of(context).push(MaterialPageRoute(builder:(_)=>MainPage(1,0))),
                                        child: Container(
                                      ...
                                      InkWell(
                                          onTap: ()=>Navigator.of(context).push(MaterialPageRoute(builder:(_)=>ReviewPage())),
                                        child: Container(
